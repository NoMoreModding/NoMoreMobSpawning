...
public class ItemRegistry {
    ...
    public static final RegistryObject<BlockItem> ANTI_MOB_BEACON = ITEMS.register("anti_mob_beacon",()-> new BlockItem(BlockRegistry.ANTI_MOB_BEACON.get(),new Item.Properties().group(ItemGroup.DECORATIONS)));
